...
obj_integrated_by_trt_umap <- DimPlot(obj_integrated, group.by  = "treatment", pt.size = 0.4, cols = c("red", "green3")) + DarkTheme() 
...
obj_integrated_by_dataset_umap <- DimPlot(obj_integrated, group.by  = "data.set", pt.size = 0.4, cols = c("white", "blue", "red")) + DarkTheme() 
...
#save.image("../../post-integ-annotated-seurObj.RData")

saveRDS(obj_integrated, "../../obj_intregrated.RDS")
