...
![Adj homeo 10X data w/ vars.toregress=nCount, new subset, PC10](/Volumes/easystore/SIMR_2019/pio-lab/scripts/adj_isl1_sib_counts_10X_figures/DV.AP.AMP_featuresPC10.png)

![Adj homeo 10X data w/ vars.toregress=nCount, new subset, PC15](/Volumes/easystore/SIMR_2019/pio-lab/scripts/adj_isl1_sib_counts_10X_figures/DV.AP.AMP_featuresPC15.png)

![Adj homeo 10X data w/ vars.toregress=nCount, new subset, P20](/Volumes/easystore/SIMR_2019/pio-lab/scripts/adj_isl1_sib_counts_10X_figures/DV.AP.AMP_featuresPC20.png)

![Adj homeo 10X data w/ vars.toregress=nCount, new subset, PC25](/Volumes/easystore/SIMR_2019/pio-lab/scripts/adj_isl1_sib_counts_10X_figures/DV.AP.AMP_featuresPC25.png)
...
![UMI Abundance between 10X and SmartSeq](/Volumes/easystore/SIMR_2019/pio-lab/scripts/integ_DGE_figures/UMIAbundance.png)

![UMI Abundance between 10X and SmartSeq](/Volumes/easystore/SIMR_2019/pio-lab/scripts/integ_DGE_figures/hist-10X.png)
![UMI Abundance between 10X and SmartSeq](/Volumes/easystore/SIMR_2019/pio-lab/scripts/integ_DGE_figures/hist-smartseq2.png)

Logging on to stowers portal using ssh

```{bash, eval=FALSE}
ssh nt2473@access.stowers.org
ssh nt2473@maple
nt2473@maple ~$ cd /n
```
